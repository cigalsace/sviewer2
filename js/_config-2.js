sviewer.config = {
    ...
    /**
     * force default language, see js/i18n.js
     */
    // lang: 'fr',
    ...
    layersBackground : [new ol.layer.Tile({
        ...
        source : new ol.source.TileWMS({
            ...
            attributions : [new ol.Attribution({
                html : 'tiles from geOrchestra, data <a href="http://www.cgiar-csi.org/data/srtm-90m-digital-elevation-database-v4-1">(c) CGIAR-CSI</a>'
            })],
        })
    }), new ol.layer.Tile({
        source : new ol.source.TileWMS({
            ...
            extent : [-20037508.34, -20037508.34, 20037508.34, 20037508.34],
            attributions : [new ol.Attribution({
                html : 'tiles from geOrchestra, data <a href="http://www.unearthedoutdoors.net/global_data/true_marble/">(c) Unearthed Outdoors</a>'
            })],
        })
    }), new ol.layer.Tile({
        source : new ol.source.TileWMS({
            ...
            extent : [-20037508.34, -20037508.34, 20037508.34, 20037508.34],
            attributions : [new ol.Attribution({
                html : 'tiles from geOrchestra, data <a href="http://earthobservatory.nasa.gov/Features/NightLights/page3.php">(c) NASA</a>'
            })],
        })
    })],
